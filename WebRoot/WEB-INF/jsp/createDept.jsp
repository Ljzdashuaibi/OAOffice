    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default wk-panel ">
                ...
                <form action="<%=basePath%>/addsave.html" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="form-inline">  
                            <div class="form-group">
                                ...
                                <label for="filePath" class="control-label wk-filed-label">部门编号: </label>
                                <div class="input-group">
                                    <input required="required" name="number" type="text" class="form-control wk-long-2col-input" placeholder="请输入部门编号" />
                                </div>
                            </div>
                        </div>
